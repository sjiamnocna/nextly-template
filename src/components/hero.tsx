...
import heroImg from "../assets/img/theme/hero.png";
        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <a
                href="https://web3templates.com/templates/NexTSly-landing-page-template-for-startups"
                target="_blank"
                rel="noopener"
              ...
              <a
                href="https://github.com/web3templates/NexTSly-template/"
                target="_blank"
                rel="noopener"
